...
import 'package:flutter_packager/src/command_runner.dart';
...
void main() {
  group('FlutterPackagerCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late FlutterPackagerCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = FlutterPackagerCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = FlutterPackagerCommandRunner();
